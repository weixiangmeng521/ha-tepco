...
RUN echo "https://github.com/weixiangmeng521/ha-tepco/releases/download/v5.0.2/tepco-linux-${BUILD_ARCH}"

RUN \
    curl -L -o /usr/bin/tepco \
    "https://github.com/weixiangmeng521/ha-tepco/releases/download/v5.0.2/tepco-linux-${BUILD_ARCH}" \
